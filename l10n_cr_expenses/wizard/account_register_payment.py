...
class AccountPaymentRegister(models.TransientModel):
    ...
    def _create_payments(self):
        ...
        if edit_mode:
            ...
            for batch_result in batches:
                #Nuevo 26-11-21
                if batch_result['lines'].invoice_id and batch_result['lines'].in_expense_sheet and batch_result['key_values']['payment_type'] == 'inbound':
                    pass
                else:
        ...
        #A CONCILIAR POR LA FACTURA DE PAGO
        # Nuevo 26-11-21
        for batch_result in batches:
            # Nuevo 26-11-21
            if batch_result['lines'].invoice_id and batch_result['lines'].in_expense_sheet and batch_result['key_values']['payment_type'] == 'inbound':
                line1 = batch_result['lines']
                line2 = batch_result['lines'].invoice_id.line_ids.filtered_domain(domain)

                if line1 and line2:
                    lines_to_reconcile = line1 + line2
